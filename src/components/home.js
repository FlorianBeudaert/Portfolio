...
const Home = () => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 h-screen pt-16" id="home">
            ...
            }} className="bg-cover bg-center flex items-center justify-center bg-base-200 shadow-lg">
            ...
            <div className="flex items-center justify-center text-xl">
                <div className="card bg-base-200 p-8 border border-base-300">
                    ...
                    <p className="text-secondary text-left"><span className="font-bold">Email :</span> <a href="mailto:beudaertflorian2@gmail.com" className="text-primary">beudaertflorian2@gmail.com</a></p>
